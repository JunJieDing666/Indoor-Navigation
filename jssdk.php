...
class JSSDK {
  ...
  private function getDeviceIdAndQrticket(){
  	$accessToken = $this->getAccessToken();
  	$productId = "41481";
  	$url = "https://api.weixin.qq.com/device/getqrcode?access_token=$accessToken&product_id=$productId";
  ...
  private function httpPost($url,$data=Infinity){
  	$curl = curl_init();
    curl_setopt($curl, CURLOPT_URL, $url);
  ...
  private function authorizeDevice(){
  	$accessToken = $this->getAccessToken();
  	$deviceid = $this->getDeviceIdAndQrticket();
  	$mac = "c7a68c169979";
